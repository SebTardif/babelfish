...
| Hook directory walk | N/A | 50 files / depth 8 | 50 files / depth 8 | Declared hook directories share one 50 JSON-file budget and stop after 8 nested directories. Walks use streamed directory entries. |

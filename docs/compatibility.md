...
| Command-hook process stdin | N/A | 1 MiB payload | 1 MiB payload | Codex and Claude Code command hooks do not receive JSON events larger than 1 MiB. Observer hooks are skipped. Decision-bearing hooks (PreToolUse, UserPromptSubmit, Stop) fail closed and block |

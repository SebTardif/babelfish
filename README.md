...
| Compatible hooks | Matching lifecycle, prompt, tool, compaction, and subagent hooks. Command-hook stdin is capped at 1 MiB; decision hooks fail closed when the cap is exceeded |

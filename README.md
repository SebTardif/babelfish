...
| Compatible hooks | Matching lifecycle, prompt, tool, compaction, and subagent hooks. Hook directories stop after 50 JSON files across all declared paths, or 8 nested directories |
